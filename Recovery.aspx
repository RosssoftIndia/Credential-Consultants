<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Recovery.aspx.cs" MasterPageFile="~/Master.master" Inherits="_Recovery" %>
            ...
            <ContentTemplate>
               <br />
                  ...
                  <div style="float:right;">
                      <asp:Label ID="Label12" runat="server" Text="Fileno:"></asp:Label>  <asp:TextBox ID="txtFileno" runat="server"></asp:TextBox>
