<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Custom_Error.aspx.cs" Inherits="Custom_Error" %>
...
<body>
    ...
    <tr><td>
        ...
        <tr><td style="text-align: center"> <asp:Label ID="notetxt" runat="server" 
                ...
                Text="An error has occured. We apologize for the inconvenience. Please close ALL browsers on your computer, before trying another application."
