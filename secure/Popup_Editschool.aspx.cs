...
public partial class secure_Popup_Editschool : System.Web.UI.Page
{
    ...
    protected void frma1_btn_submit_Click(object sender, EventArgs e)
    {
        ...
        if (Page.IsValid)
        {
            ...
            bool result = ClientAdmin.Utility.update_education(Convert.ToInt32(Session["Request_id"].ToString()), Convert.ToInt32(frma1_opt_country.SelectedValue.ToString()), 1, institution_id, frma1_start_year.SelectedItem.ToString(), frma1_end_year.SelectedItem.ToString(), degree_id, graduated, DateDegreeAwarded, 1,frma1_city.Text,frma1_state.Text,Convert.ToInt32(Session["id"].ToString()));
    ...
    public void selected_country(string option)
    {
        ...
        if (frma1_opt_country.SelectedIndex != 0)
        {
           ...
           ClientAdmin.Utility.Getdegree_update(frma1_option_degree, 0, Convert.ToInt32(frma1_opt_country.SelectedValue.ToString()), Session["Admin_Customer"].ToString());
           ClientAdmin.Utility.Add_New(frma1_option_degree);
