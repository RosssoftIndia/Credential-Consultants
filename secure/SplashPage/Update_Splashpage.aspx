<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Update_Splashpage.aspx.cs" MasterPageFile="~/secure/Master.master" Inherits="secure_SplashPage_Splashpage" %>
...
<asp:TemplateField HeaderText="Online Application">
    <EditItemTemplate>
  <asp:RadioButtonList ID="onlineapp" runat="server" RepeatDirection="Horizontal" SelectedValue='<%# Eval("OnlineApp") %>'>
