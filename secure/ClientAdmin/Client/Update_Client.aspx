<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Update_Client.aspx.cs" MasterPageFile="~/secure/Master.master" Inherits="secure_ClientAdmin_Client_Update_Client" %>
...
<br />
   <asp:DetailsView ID="DetailsView_Client" runat="server" CssClass="detailview_css" 
        ...
        <asp:TextBox ID="txtName" Width="300px" MaxLength="200"   runat="server" Text='<%# Eval("Name") %>' ></asp:TextBox>
            ...
            <EditItemTemplate> 
                   <asp:TextBox ID="txtDomainName" runat="server" Width="300px" MaxLength="100" Enabled="false"  Text='<%# Eval("SubDomainName") %>'></asp:TextBox>                 
                 </EditItemTemplate>
            </asp:TemplateField> 
                <asp:TemplateField HeaderText="Parent">                 
            <EditItemTemplate>  
            <asp:DropDownList ID="dpclients" runat="server" onload="dpclients_Load" Enabled="false"> </asp:DropDownList>              
