<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Add_Client.aspx.cs" MasterPageFile="~/secure/Master.master" Inherits="secure_ClientAdmin_Client_Add_Client" %>
...
<asp:Content ID="HomeContent" ContentPlaceHolderID ="Content" runat="server">
      ...
      <%--  <asp:UpdatePanel ID="UpdatePanel1" UpdateMode="Conditional"   runat="server">    
        ...
        ErrorMessage="Client Name Required" >*</sv:RequiredFieldValidator>
            ...
            <InsertItemTemplate> 
                   <asp:TextBox ID="txtDomainName" runat="server" Width="300px" AutoPostBack="true" OnTextChanged="DomainName_TextChanged"  MaxLength="100" ></asp:TextBox>
                    <sv:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtDomainName"
        ErrorMessage="Domain Name Required" >*</sv:RequiredFieldValidator><br />
                <asp:Label ID="errormsg" runat="server" ForeColor="Red" Width="500px"></asp:Label>  
                 </InsertItemTemplate>
            </asp:TemplateField> 
                <asp:TemplateField HeaderText="Type">                 
            <InsertItemTemplate>                 
                <asp:DropDownList ID="dpclients" runat="server" Enabled="false">
                </asp:DropDownList>            
                  </InsertItemTemplate>
            </asp:TemplateField>          
