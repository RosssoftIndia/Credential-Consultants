<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Add_Gradescale.aspx.cs" MasterPageFile="~/secure/Master.master" Inherits="secure_Gradescale_Add_Gradescale" %>
<%@ Register Assembly="CKEditor.NET" Namespace="CKEditor.NET" TagPrefix="CKEditor" %>
<asp:Content ID="Homesubmenu" ContentPlaceHolderID ="Submenu" runat="server">  
 <span class="title" >Add Gradescale</span>
   <div class="submenu_style">     
           <div class="buttons">   
 <a href="Browse_Gradescale.aspx?search=&t1=0" class="regular">
...
<asp:ScriptManager ID="ScriptManager1" runat="server">
        ...
        <asp:UpdatePanel ID="UpdatePanel1" UpdateMode="Conditional"   runat="server">    
            ...
            <br />
            <br />
   <asp:DetailsView ID="DetailsView_Gradescale" runat="server" AutoGenerateRows="False" DefaultMode="Insert" CssClass="detailview_css"  PagerStyle-CssClass="pgr"   AlternatingRowStyle-CssClass="alt">       
        <Fields>
