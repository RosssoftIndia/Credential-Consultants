<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Popup_Addschool.aspx.cs" MasterPageFile="~/secure/popupMaster.master" Inherits="secure_Popup_Addschool" %>
...
<asp:DropDownList ID="frma1_opt_country" runat="server" Width="204px" AutoPostBack="True" OnSelectedIndexChanged="frma1_opt_country_SelectedIndexChanged" AppendDataBoundItems="true">
                  ...
                  <sv:RequiredFieldValidator ID="frma1_RequiredFieldValidator01" 
        runat="server" ControlToValidate="frma1_opt_country" 
        ErrorMessage="You must Select Country" ValidationGroup="frma1_countrygroup" 
        InitialValue="Select">*</sv:RequiredFieldValidator>
...
<asp:Button ID="frma1_btn_clear" CssClass="btncolor" runat="server" Text="Clear" OnClick="frma1_btn_clear_Click" />&nbsp;&nbsp;<asp:Button 
        ID="frma1_btn_submit"  CssClass="btncolor" 
runat="server" Text="Submit" OnClick="frma1_btn_submit_Click" 
        ValidationGroup="frma1_group" CausesValidation="False" />
</td> 
</tr> 
</table> 
