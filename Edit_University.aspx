<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Edit_University.aspx.cs" MasterPageFile="~/popupMaster.master"  Inherits="Edit_University" %>
...
<br /> 
Start :<asp:DropDownList ID="frma2_start_year" runat="server" Width="58px"></asp:DropDownList>
...
<td colspan="2"  align="center"> 	
        <asp:Button ID="frma2_btn_clear" runat="server" Text="Clear" CssClass="btncolor"  OnClick="frma2_btn_clear_Click" />&nbsp;&nbsp;<asp:Button ID="frma2_btn_submit" CssClass="btncolor"
            runat="server" Text="Update" OnClick="frma2_btn_submit_Click" ValidationGroup="frma2_group" CausesValidation="False" />
  </td> 
</tr> 
</table>				
