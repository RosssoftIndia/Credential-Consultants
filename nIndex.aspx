<%@ Page Language="C#" AutoEventWireup="true" CodeFile="nIndex.aspx.cs" MasterPageFile="~/AppMaster.master"   Inherits="nIndex" %>

<%@ Register Src="~/nMenu.ascx" TagName="Menu" TagPrefix="uc1" %>
     ...
     <div>
         <table width="100%">
             ...
             <tr>
                 ...
                 <td style="width: 50%; text-align: left; font-weight: bold; font-size: 10px; color: #584B42;">
                     Go Back to Step 2:<br />
                     <span style="color:#AEAEAE; font-style: italic;">Purpose</span>
                 </td>
                 <td style="width: 50%; text-align: right;font-weight:bold; font-size: 10px; color: #584B42;">
                     Continue to Step 4:<br />
    ...
    <table width="100%"> 
      <tr>
        ...
        <br />
         ...
         <table width="100%"><tr>
         <td>
           <asp:GridView ID="servicegrid" runat="server" AutoGenerateColumns="False"  DataKeyNames="id" OnLoad="servicegrid_Load"
           ondatabound="servicegrid_DataBound" style="TEXT-ALIGN: left" CssClass="gridview_css" PagerStyle-CssClass="pgr" AlternatingRowStyle-CssClass="alt" >
                   <Columns>
            <asp:TemplateField ShowHeader="False" SortExpression="Name">                           
                           <ItemTemplate>
